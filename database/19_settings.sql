-- ============================================================
-- SGTM — Migración: Configuración general del sistema
-- ============================================================
...
CREATE TABLE IF NOT EXISTS settings (
  ...
  business_name      VARCHAR(120)  NOT NULL DEFAULT 'SGTM',
  ...
  footer_message     VARCHAR(500)  NULL DEFAULT 'Gracias por confiar en SGTM',
...
VALUES (1, 'SGTM', 'Bogotá, Colombia', '3183531500', '573183531500',
